...
from ifps_project.models import DeathCertificate
from ifps_project.models import InsuredPerson, Beneficiary
        ...
        for person in insured_persons:
            if person.id_number in deceased_ids:
                ...
                try:
                    ...
                    self.stdout.write(f"No beneficiary found for policy {person.policy_id}")
                    continue
                ...
                send_mail(
                    ...
                    message=(
                        ...
                        f"We regret to inform you that {person.name}, the insured individual under policy number {person.policy_id}, "
